    ...
    protected void onEnvoyerButtonClick() {
        ...
        if(message.equals("bye")) {
            ...
            try {
                ...
                client.sendMessage(clientSocket, message, client.sortie, pseudo);

                String messageInput = client.receiveMessage(clientSocket, client.entrée);
                System.out.println(messageInput);
                chatArea.appendText(pseudo + " : " + messageInput + "\n");
                messageArea.clear();
